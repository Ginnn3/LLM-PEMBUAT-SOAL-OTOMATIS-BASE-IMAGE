...
if (isset($_GET['reset']) && $_GET['reset'] == 1) {
    $reset_stmt = $conn->prepare("DELETE FROM user_answers_hard WHERE fullname = ?");
...
// Ambil soal terakhir yang dijawab user berdasarkan fullname dari tabel user_answers_hard
$stmt = $conn->prepare("SELECT MAX(question_id) AS last_answered FROM user_answers_hard WHERE fullname = ?");
...
// Array data soal hard (gunakan gambar berbeda jika ada)
$questions = [
    1 => ['title' => 'Question 1', 'img' => $base_url . 'app/general/images/tree.png'],
    2 => ['title' => 'Question 2', 'img' => $base_url . 'app/general/images/coffe.png'],
    3 => ['title' => 'Question 3', 'img' => $base_url . 'app/general/images/unicorn.png'],
    4 => ['title' => 'Question 4', 'img' => $base_url . 'app/general/images/bird.png'],
    5 => ['title' => 'Question 5', 'img' => $base_url . 'app/general/images/person.png'],
    6 => ['title' => 'Question 6', 'img' => $base_url . 'app/general/images/motorcycle.png'],
];
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Image-General-Hard</title>
...
<div class="container">
   <div class="image-grid">
    <?php foreach ($questions as $num => $q): 
        ...
        if ($is_answered && $is_all_done) {
            $link = $base_url . "app/general/question-hard/question-$num.php";
            $class = 'unlocked';
            $onclick = '';
        }
  ...
  <a href="<?= $base_url ?>app/general/pict-general-hard.php?reset=1" 
     class="btn-retry">
