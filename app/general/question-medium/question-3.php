...
// Pastikan soal sebelumnya sudah dijawab di tabel medium
...
if ($row['cnt'] == 0) {
    header("Location: " . $base_url . "app/general/question-medium/question-2.php");
    exit;
}
?>
...
<p style="font-family: 'Righteous', cursive; font-size: 18px; margin-bottom: 12px;">
  ...
  A clock is sitting on a table next to some pillows and blankets. What time does it say?
</p>
    <img src="<?= $base_url ?>app/general/images/clock.png" alt="Question Image" width="200" style="margin-bottom: 20px;" />
