...
if ($row['cnt'] == 0) {
    header("Location: " . $base_url . "app/general/question-medium/question-4.php");
    exit;
}
?>
...
<body>
  ...
  <div class="container">
    <h2>Question 5: Short answer based on the image shown</h2>
<p style="font-family: 'Righteous', cursive; font-size: 18px; margin-bottom: 12px;">
  Look at the image below. Short answer:<br>
  A red bicycle with a basket of flowers is parked in front of a brick wall. What color are the flowers in the basket?
</p>
    <img src="<?= $base_url ?>app/general/images/bicycle.png" alt="Question Image" width="200" style="margin-bottom: 20px;" />
