...
// Ambil jawaban dan status benar/salah user dari soal 1 sampai 6 (medium mode)
$stmt = $conn->prepare("SELECT question_id, answer, is_correct FROM user_answers_medium WHERE fullname = ? AND question_id BETWEEN 1 AND 6 ORDER BY question_id ASC");
...
$explanations = [
  1 => "The correct answer is 'Yellow' because the picture of a banana is yellow.",
  2 => "The correct answer is 'Blue' because the picture shows the sky is blue.",
  3 => "The correct answer is '12:00' because the picture shows the direction of the long and short hands of the clock at 12:00",
  4 => "The correct answer is 'Laptop' because the picture shows colorful objects on the laptop.",
  5 => "The correct answer is 'Pink' because the flowers in the basket show the color pink.",
  6 => "The correct answer is 'A Paintbrush' because the picture shows a woman holding a paintbrush"
];
