...
// Pastikan soal sebelumnya sudah dijawab (dari tabel medium)
...
if ($row['cnt'] == 0) {
    header("Location: " . $base_url . "app/general/question-medium/question-3.php");
    exit;
}
?>
<head>
...
<body>
  ...
  <div class="container">
    <h2>Question 4: Short answer based on the image shown</h2>
<p style="font-family: 'Righteous', cursive; font-size: 18px; margin-bottom: 12px;">
  Look at the image below. Short answer :<br>
  What is the colorful object on the table?
</p>
    <img src="<?= $base_url ?>app/general/images/laptop.png" alt="Question Image" width="200" style="margin-bottom: 20px;" />
