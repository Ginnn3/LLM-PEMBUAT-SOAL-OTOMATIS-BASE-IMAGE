...
if (isset($_GET['reset']) && $_GET['reset'] == 1) {
    $reset_stmt = $conn->prepare("DELETE FROM user_answers_easy WHERE fullname = ?");
...
// Ambil soal terakhir yang dijawab user berdasarkan fullname dari tabel user_answers_easy
$stmt = $conn->prepare("SELECT MAX(question_id) AS last_answered FROM user_answers_easy WHERE fullname = ?");
...
// Array data soal easy (gunakan gambar berbeda jika ada)
$questions = [
    1 => ['title' => 'Question 1', 'img' => $base_url . 'app/general/images/bus.png'],
    2 => ['title' => 'Question 2', 'img' => $base_url . 'app/general/images/firefighter.png'],
    3 => ['title' => 'Question 3', 'img' => $base_url . 'app/general/images/pizza.png'],
    4 => ['title' => 'Question 4', 'img' => $base_url . 'app/general/images/balloon.png'],
    5 => ['title' => 'Question 5', 'img' => $base_url . 'app/general/images/kite.png'],
    6 => ['title' => 'Question 6', 'img' => $base_url . 'app/general/images/dragon.png'],
];
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Image-General-Easy</title>
...
<div class="container">
   <div class="image-grid">
    <?php foreach ($questions as $num => $q): 
        ...
        if ($is_answered && $is_all_done) {
            $link = $base_url . "app/general/question-easy/question-$num.php";
            $class = 'unlocked';
            $onclick = '';
        }
  ...
  <a href="<?= $base_url ?>app/general/pict-general-easy.php?reset=1" 
     class="btn-retry">
