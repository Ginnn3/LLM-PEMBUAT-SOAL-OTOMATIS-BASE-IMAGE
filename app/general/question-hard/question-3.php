...
// Pastikan soal sebelumnya sudah dijawab di tabel hard
...
if ($row['cnt'] == 0) {
    header("Location: " . $base_url . "app/general/question-hard/question-2.php");
    exit;
}
?>
...
<img src="<?= $base_url ?>app/general/images/unicorn.png" alt="Question Image" width="200" style="margin-bottom: 20px;" />
<i style="display: block; font-family: 'Righteous', cursive; font-size: 18px; margin-bottom: 10px;">
Describe the unicorn's appearance in detail, including its color, size, and surroundings. How does the unicorn's presence impact the scene?
</i>
