...
// Ganti tabel menjadi user_answers_hard
...
<img src="<?= $base_url ?>app/general/images/tree.png" alt="Question Image" width="200" style="margin-bottom: 20px;" />
<i style="display: block; font-family: 'Righteous', cursive; font-size: 18px; margin-bottom: 10px;">
Write an essay discussing the symbolism of the lone tree in this image. How does its isolation from other trees convey a sense of solitude, independence, or vulnerability?
</i>
