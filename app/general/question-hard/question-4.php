...
// Pastikan soal sebelumnya sudah dijawab (dari tabel hard)
...
if ($row['cnt'] == 0) {
    header("Location: " . $base_url . "app/general/question-hard/question-3.php");
    exit;
}
?>
<head>
...
<img src="<?= $base_url ?>app/general/images/bird.png" alt="Question Image" width="200" style="margin-bottom: 20px;" />
<i style="display: block; font-family: 'Righteous', cursive; font-size: 18px; margin-bottom: 10px;">
Write an essay about the beauty of nature and how birds contribute to our appreciation for the environment. Include at least three specific examples of birds in your essay, focusing on their unique features and behaviors?
</i>
