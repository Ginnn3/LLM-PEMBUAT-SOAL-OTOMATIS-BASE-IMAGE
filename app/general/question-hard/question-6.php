...
if ($row['cnt'] == 0) {
    header("Location: " . $base_url . "app/general/question-hard/question-5.php");
    exit;
}
?>
...
<img src="<?= $base_url ?>app/general/images/motorcycle.png" alt="Question Image" width="200" style="margin-bottom: 20px;" />
<i style="display: block; font-family: 'Righteous', cursive; font-size: 18px; margin-bottom: 10px;">
Write an essay about the beauty of nature and how it can be experienced through various means such as hiking or riding motorcycles?
</i>
