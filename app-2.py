...
4. Explanation: ...
""".strip()
        pattern = r"1\. Description:.*?2\. Question:.*?a\..*?b\..*?c\..*?3\. Answer:.*?4\. Explanation:"
...
4. Explanation: ...
""".strip()
        pattern = r"1\. Description:.?2\. Question:.?3\. Answer:.*?4\. Explanation:"
...
4. Explanation: ...
""".strip()
        pattern = r"1\. Description:.*?2\. Essay Question:.*?3\. Sample Answer:.*?4\. Explanation:"
    ...
    return output if match else "The output format is invalid. Please try another image."

# ========== ENDPOINT EASY (Pilihan Ganda) ==========
